...
const blenderScript = path.join(appDirectory, "assets/blender/danxiao-rxgj-12.py");
const macBlender = "/Applications/Blender.app/Contents/MacOS/Blender";
const blenderBinary =
  process.env.RXGJ12_BLENDER_BINARY ?? (fs.existsSync(macBlender) ? macBlender : "blender");
