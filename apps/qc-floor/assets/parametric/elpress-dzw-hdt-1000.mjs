...
const blenderScript = path.join(appDirectory, "assets/blender/elpress-dzw-hdt-1000.py");
const macBlender = "/Applications/Blender.app/Contents/MacOS/Blender";
const blenderBinary =
  process.env.DZWHDT1000_BLENDER_BINARY ?? (fs.existsSync(macBlender) ? macBlender : "blender");
