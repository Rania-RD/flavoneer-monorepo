...
const modelPath = path.join(appDirectory, "public/models/danxiao-gta450-120.glb");
const reportPath = path.join(
  appDirectory,
  "assets/previews/danxiao-gta450-120/asset-report.json",
);
...
const requiredNodes = [
  "machine.gta450-120",
  "structure.frame",
  "inspection.infeed_conveyor",
  "inspection.product_transfer",
  "inspection.film_feed",
  "inspection.longitudinal_seal",
  "inspection.end_seal",
  "inspection.control_panel",
  "safety.emergency_controls",
];
...
const rootNode = gltf.nodes.find((node) => node.name === "machine.gta450-120");
...
const report = {
  ...
  asset: "danxiao-gta450-120.glb",
  sourceBlend: "assets/blender/danxiao-gta450-120.blend",
