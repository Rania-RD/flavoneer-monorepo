...
const modelPath = path.join(appDirectory, "public/models/gram-gif-1200.glb");
const reportPath = path.join(appDirectory, "assets/previews/gif-1200/asset-report.json");
...
const rootNode = gltf.nodes.find((node) => node.name === "machine.gif-1200");
...
const report = {
  ...
  asset: "gram-gif-1200.glb",
  sourceBlend: "assets/blender/gif-1200.blend",
