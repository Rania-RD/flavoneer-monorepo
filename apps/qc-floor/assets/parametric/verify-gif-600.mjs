...
const modelPath = path.join(appDirectory, "public/models/gram-gif-600.glb");
const reportPath = path.join(appDirectory, "assets/previews/gif-600/asset-report.json");
...
const rootNode = gltf.nodes.find((node) => node.name === "machine.gif-600");
...
const report = {
  ...
  asset: "gram-gif-600.glb",
  sourceBlend: "assets/blender/gif-600.blend",
