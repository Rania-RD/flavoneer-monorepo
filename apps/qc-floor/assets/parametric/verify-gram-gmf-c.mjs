...
const modelPath = path.join(appDirectory, "public/models/gram-gmf-c.glb");
const reportPath = path.join(appDirectory, "assets/previews/gram-gmf-c/asset-report.json");
...
const requiredNodes = [
  "machine.gmf-c",
  "structure.frame",
  "inspection.slat_conveyor",
  "inspection.container_magazine",
  "inspection.filling_station",
  "inspection.control_panel",
  "inspection.topping_station",
  "inspection.closing_station",
  "inspection.wash_unit",
...
const rootNode = gltf.nodes.find((node) => node.name === "machine.gmf-c");
...
const report = {
  ...
  asset: "gram-gmf-c.glb",
  sourceBlend: "assets/blender/gram-gmf-c.blend",
