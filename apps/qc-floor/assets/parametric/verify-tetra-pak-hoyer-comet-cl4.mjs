...
const modelPath = path.join(appDirectory, "public/models/tetra-pak-hoyer-comet-cl4.glb");
const reportPath = path.join(
  appDirectory,
  "assets/previews/tetra-pak-hoyer-comet-cl4/asset-report.json",
);
...
const requiredNodes = [
  "machine.hoyer-comet-cl4",
  "structure.frame",
  "inspection.four_lane_conveyor",
  "inspection.cup_cone_dispenser",
  "inspection.chocolate_sprayer",
  "inspection.filling_station",
  "inspection.topping_station",
  "inspection.dry_ingredient_station",
  "inspection.lid_station",
  "inspection.ejection_station",
  "inspection.control_panel",
  "utilities.drive_and_pneumatics",
];
...
if (!fs.existsSync(modelPath)) {
  fail(`Missing model ${modelPath}. Run the CL4 Blender build first.`);
  process.exit();
}
...
const rootNode = gltf.nodes.find((node) => node.name === "machine.hoyer-comet-cl4");
...
if (rootNode?.extras?.laneCount !== 4) {
  fail("The root node must document the CL4 four-lane configuration.");
}
...
const report = {
  ...
  asset: "tetra-pak-hoyer-comet-cl4.glb",
  sourceBlend: "assets/blender/tetra-pak-hoyer-comet-cl4.blend",
