...
const modelPath = path.join(appDirectory, "public/models/tetra-pak-hoyer-frigus-sf-600.glb");
const reportPath = path.join(
  appDirectory,
  "assets/previews/tetra-pak-hoyer-frigus-sf-600/asset-report.json",
);
const expectedBounds = {
  min: [-0.665, 0, -0.3775],
  max: [0.665, 1.665, 0.3775],
  size: [1.33, 1.665, 0.755],
};
const requiredNodes = [
  "machine.hoyer-frigus-sf-600",
  "structure.cabinet",
...
const rootNode = gltf.nodes.find((node) => node.name === "machine.hoyer-frigus-sf-600");
...
if (rootNode?.extras?.engineeringUse !== false) fail("The root node must state engineeringUse=false.");
...
const report = {
  ...
  asset: "tetra-pak-hoyer-frigus-sf-600.glb",
  sourceBlend: "assets/blender/tetra-pak-hoyer-frigus-sf-600.blend",
  referenceManifest: "assets/references/tetra-pak-hoyer-frigus-sf-600/manifest.json",
  ...
  limits: { maxFileBytes: 1_500_000, maxTriangles: 40_000, maxMaterials: 12, maxTextures: 0 },
};
