...
const DashboardLayout: React.FC<DashboardLayoutProps> = ({ children }) => {
  ...
  return (
    <div className="flavoneer-dashboard relative min-h-screen overflow-x-clip bg-[#eef8eb] font-sans text-[#143d32] transition-colors duration-300 dark:bg-[#0d2b24] dark:text-[#f5f4e8]">
      <div
        aria-hidden="true"
      ...
      <main className="relative z-10 min-h-screen flex-1 p-4 pb-28 transition-all duration-300 md:ms-28 md:p-6 md:pb-8 lg:ms-32">
        <div className="mx-auto max-w-[1600px]">
          ...
          <div className="dashboard-route-surface" key={location.pathname}>
            {children}
          </div>
        </div>
      </main>
